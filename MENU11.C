...
void ticTacToe(){
    ...
    do
    {
	    ...
	    g(5, 20);
	    p("\033[0;33mPLAYER %d, enter a no.:   ", player);
	    s("%d", &move);
...
void facto() {
    ...
    setcolor(14);
    settextstyle(0, HORIZ_DIR, 4);
    outtextxy(175, 15, "FACTORIAL");

    setcolor(10);
    settextstyle(6, HORIZ_DIR, 1);
    outtextxy(165, 87, "Enter the number to get the factorial: ");
    gotoxy(60, 7);
    scanf("%lld", &n);
...
// Main menu function
	...
	g(2,8); t(11); cprintf("1. | Exponent\n");
	g(2,10); t(14); cprintf("2. | Maze\n");
	g(2,12); t(13); cprintf("3. | Bar Graph\n");
	g(2,14); t(11); cprintf("4. | Tic Tac Toe\n");
	g(2,16); t(14); cprintf("5. | Binary Tree - TRAVERSAL\n");
	g(2,18); t(13); cprintf("6. | Binary Tree - MAKER\n");
	g(38,8); t(11); cprintf("7.  | Garage - STACK\n");
	g(38,10); t(14); cprintf("8.  | Garage - QUEUE\n");
	g(38,12); t(13); cprintf("9.  | Fibonnaci\n");
	g(38,14); t(11); cprintf("10. | Factorial\n");
	g(38,16); t(14); cprintf("11. | Tower of Hanoi\n");
	g(38,18); t(13); cprintf("12. | Digital Clock\n");
